...
const COLORES: Record<EstadoPlano, string> = {
  ...
  bloqueado: 'border border-slate-200 bg-white text-slate-700',
  sin_ficha: 'border border-slate-200 bg-white text-slate-700',
  revisar: 'border border-slate-200 bg-white text-slate-700',
};
